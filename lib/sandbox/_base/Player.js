 ...
 * Time: 4:31 PM
 */
define(["dojo/_base/declare", "sandbox/_base/Deck", "sandbox/_base/Hand", "sandbox/_base/Playfield"],
    function(declare, Deck, Hand, Playfield){
        'use strict';
        ...
        return declare(null,{
            ...
            setClassAccentColor : function(){
                if(this.playerDesignation == "player1"){
                    this.classAccentColor = classAccents[0][0];
                } else {
                    this.classAccentColor = classAccents[1][0];
                }
            }
        })
    });